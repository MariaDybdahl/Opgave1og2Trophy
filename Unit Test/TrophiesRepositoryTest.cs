...
namespace Unit_Test
{
    ...
    {
        private readonly Trophy TrophyWrongYear = new() { Competition = "Test", Year = 1940 };
        private Trophy trophyCompetitionNull = new Trophy(2, null, 2013);
        private Trophy trophyCompetitionLessThen3 = new Trophy(3, "Gå", 2012);
        private Trophy TrophyNull = null;
